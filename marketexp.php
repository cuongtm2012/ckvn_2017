	...
	if ($result->num_rows > 0) {
		 ...
		 while($row = $result->fetch_assoc()) {
			 ...
			 if($dmx == "TRUNG LAP"){
				 ...
				 echo "<tr>
				 <td bgcolor=".findTicker($vpazone, $vpastatus, $isignal, $t3signal, $emashort, $emamid, $coppock, $arsi, $stochastic, $mfi, $ematrend)." width=\"100px\"><a target = '_blank' href=".viewchart($ticker)."> ". $row["ticker"]." </a></td>
